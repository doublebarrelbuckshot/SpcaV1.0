...
public class FAQFragment extends Fragment implements View.OnClickListener, GetActionBarTitle {
   ...
   // String faqTitle;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        taText = (WebView)rootView.findViewById(R.id.html_text);

        //faqText = getString(R.string.faqText);
        //faqTitle =  getString(R.string.faqTitle);

        taText.loadData(getString(R.string.faqText),"text/html", "utf-8"); //Html.fromHtml(getString(R.string.faqText)));
