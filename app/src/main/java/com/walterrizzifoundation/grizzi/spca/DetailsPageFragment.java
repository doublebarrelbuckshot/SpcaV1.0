...
*/
    ...
    private class DetailsPagerAdapter extends android.support.v4.view.PagerAdapter {
        ...
        public Object instantiateItem(View collection, int position) {
            ...
            /*
            Additional translation of primary breed for most popular types of cats
             */
            if(Locale.getDefault().getISO3Language().equals("fre")
                    || Locale.getDefault().getISO3Language().equals("fra")) {
                if(animalPrimaryBreed.equalsIgnoreCase("Domestic Shorthair")) {
                    animalPrimaryBreed = "Domestique à poil court";
                }
                else if(animalPrimaryBreed.equalsIgnoreCase("Domestic Medium Hair")) {
                    animalPrimaryBreed = "Domestique à poil mi-long";
                }
...
//             */
 ...
 /*
            ...
            if(animalSex.equalsIgnoreCase("M") || animalSex.equalsIgnoreCase("MALE") ) {
                // Log.d("SEX", "SEX MALE");
                animalSex = getResources().getString(R.string.male);
                animalSexTV.setText(animalSex);
            }
            else if(animalSex.equalsIgnoreCase("F")|| animalSex.equalsIgnoreCase("FEMALE")) {
                animalSex = getResources().getString(R.string.female);
                ...
                public void onClick(View v) {
                    ...
                    try{
                        ...
                        String smsText =  getResources().getText(R.string.lookAtWhatIFound) + "\n" +
                                getResources().getText(R.string.availableAtSPCA) + "\n" +
            ...
            if(dbh.isFavorite(db,animalID )){
                isFav = true;
                btnFav.setImageResource(R.drawable.ic_favorite_black_48dp);
            }
            else{
                btnFav.setImageResource(R.drawable.ic_favorite_outline_black_48dp);
                isFav = false;
            }
