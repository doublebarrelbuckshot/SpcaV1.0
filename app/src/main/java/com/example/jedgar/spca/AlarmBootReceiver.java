...
public class AlarmBootReceiver extends BroadcastReceiver{
    com.example.jedgar.spca.Alarm alarm;
    Context context;
    @Override
    ...
    public void charger(){
        ...
        try {
            ...
            try {
                alarm = (com.example.jedgar.spca.Alarm) alarmOIS.readObject();
            } finally {
                try {
                    alarmOIS.close();
                } finally {
            ...
            alarm = new com.example.jedgar.spca.Alarm();
    ...
    private void planifierAlarm() {
        ...
        Intent intent = new Intent(context, com.example.jedgar.spca.AlarmReceiver.class);

        //On créer le pending Intent qui identifie l'Intent de reveil avec un ID et un/des flag(s)
        PendingIntent pendingintent = PendingIntent.getBroadcast(context, NotificationPageFragment.ALARM_ID, intent, 0);
